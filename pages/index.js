  ...
  return(
    <div>
      ...
      <div className="container">
        <div className="card card-bg-img bg-img bg-overlay mb-3" style={{backgroundImage: "url(&#x27;images/3.jpg&#x27;)"}}>
      ...
      <div className="container">
        <div className="card bg-primary mb-3 bg-img" style={{backgroundImage: "url(&#x27;images/1.png&#x27;)"}}>
          <div className="card-body direction-rtl p-5">
